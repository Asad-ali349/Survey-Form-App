...
<head>
  ...
  <script type="text/javascript">
    $(function()
    {
        ...
        var line<?php echo $i; ?> = <?php echo json_encode($question->choice_counts_percent_age); ?>;
        
        <?php echo json_encode($question->choice_counts_percent_age); ?>
...
<body>
  <div id="main">
    ...
    <div id="site_content">
      ...
      <h1>Total No. Responses Submitted: <?php echo $survey->responses_count ; ?></h1>
      <div id="content">
        <?php $i = 1; ?>
        <?php foreach ($survey->questions as $question): ?>
